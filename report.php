        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="sell.php" class="nav-item nav-link active"><i class="bi bi-receipt-cutoff me-2"></i></i>Report</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
...
<?php } }?>
                    ...
                    <a href="#print" class="btn btn-success" style="margin-top: 20px;" onclick="print()">Print</a>
                </div>
            </div>
            <!-- Recent Sales End -->
