...
$query3 = "SELECT * FROM stock where status = 'Current'";

$result3 = $conn->query($query3);

$query4 = "SELECT * FROM stock Where status = 'Incoming' ";
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Incoming Stock</h6>
                    </div>
...
?>
                                <tr>
                                    ...
                                    <td><?php echo $stockinfo['date'];?></td>
                                    <td><?php echo $stockinfo['Name'];?></td>
                                    <td><?php echo $stockinfo['Stock'];?></td>
                                    <td><a class="btn btn-sm btn-success" href="re.php?id='<?php echo $stockinfo['id'] ?>'">Received</a></td>
                                </tr>
<?php } }?>
                            </tbody>
                        </table>
